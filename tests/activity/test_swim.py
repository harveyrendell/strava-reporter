...
def test_swim_all_fields():
    ...
    assert embed.fields[0].value == "A nice morning swim"
    assert embed.fields[1].name == "Distance"
    assert embed.fields[1].value == "400 m"
    assert embed.fields[2].name == "Moving Time"
    assert embed.fields[2].value == "8:56"
    assert embed.fields[3].name == "Pace"
    assert embed.fields[3].value == "2:14 /100m"
